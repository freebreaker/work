      ...
      <div id="components-layout">
        <Layout>
          <Sider
            ...
            collapsed={this.state.collapsed}
          >
            <img src="/app/admin_logo.png" style={{ margin: "12px 0", height: "auto" ,width:110 }} className="logo" />
            ...
            >
              ...
              <SubMenu
                key="sub5"
                title={<span><Icon type="paper-clip" /><span>其他管理</span></span>}
              >
          ...
          <Layout style={{ minHeight: "100vh" }}>
            ...
            >
              <Suspense fallback={null}>
                ...
                <Route path="/admin/home/news" component={News} />
